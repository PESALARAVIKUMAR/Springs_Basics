...
/**
 * Servlet implementation class Login_Validationn
 */
@WebServlet("/Login_Validationn")
public class Login_Validation extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("username").equals("ravi") && request.getParameter("password").equals("ravi"))
		{
			out.println("<script>alert('Welcome Ravi')</script>");
